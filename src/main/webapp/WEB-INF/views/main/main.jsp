...
<body>
    ...
    <div class="main-container">
        ...
        <div class="dashboard-card full-width-card mb-4">
            ...
            <div class="stock-top10-grid">
                <div class="stock-sub-col">
                    <c:forEach var="stock" items="${topStocks}" varStatus="status" begin="0" end="4">
                ...
                <div class="stock-sub-col">
                    <c:forEach var="stock" items="${topStocks}" varStatus="status" begin="5" end="9">
                        <a href="${pageContext.request.contextPath}/stock/${stock.stockCode}" class="stock-item">
                            <div class="stock-left">
                                <span class="rank-badge">${status.count}</span>
                                <div class="stock-name-box">
